...
const STRINGS = {
  en: {
    ...
    "stage.observation": "Observation", "stage.question": "Question",
    "observation.title": "Look closely", "observation.lede": "Before you ask a question, notice something real. Explore, and see what stands out.",
    "observation.no-activity": "This activity has no observation step wired up yet.",
    "question.title": "What are you trying to find out?", "question.lede": "Every investigation starts with a real question. Choose the one this investigation is designed to answer.",
    "question.note": "This isn't marked right or wrong — it's the question your hypothesis and experiment will try to answer.",
    ...
    "hypothesis.lede": "A hypothesis is an educated guess — your best scientific prediction, based on what you already know, made before you test anything. Record what you think now — you will be able to change it after you have run some trials.",
    "hypothesis.note": "A hypothesis is never marked right or wrong — good scientists revise their hypothesis when the evidence tells them to.",
    ...
    "explain.title.science": "Draw your conclusion",
    ...
    "mark-singular": "mark",
    "marks-source": "Marks for this row come from: {source}",
    "skill-focus": "Skill focus: {text}",
    "submission-locked": "Submitted on {date} — your answers are locked and cannot be changed.",
    "assessed.lock-warning-title": "Important: ",
    "assessed.lock-warning-body": "This is assessed work. Once you press Final Submit, your answers will be locked and you will not be able to change them.",
    "assessed.final-submit": "Final Submit",
    "assessed.confirm-submit": "Once you submit, your answers will be locked and you won't be able to change them. Submit now?",
    "assessed.submitted-toast": "Submitted — your receipt has been downloaded.",
    "assessed.submitted-on": "Submitted on {date}. Your answers are locked.",
    "assessed.download-receipt-again": "Download my submission receipt again",
    "assessed.teacher-only": "Teacher tool",
    "assessed.teacher-note": "This generates the full marking document, including the hidden marking scheme. Do not share this button, link or file with students who have not yet submitted.",
    "assessed.teacher-generate": "Generate Teacher Marking PDF",
    ...
    "pdf.student-evidence": "Student's response:",
    "pdf.marking-scheme": "Marking guidance — {max} marks available",
    "pdf.award-point": "Award {marks} {unit} for:",
    "pdf.accept": "Accept: ",
    "pdf.insufficient": "Not sufficient on its own: ",
    "pdf.depends-on": "Only award this point if point {n} above is also awarded.",
    "pdf.marks-awarded-blank": "Marks awarded: ____ / {max}",
    ...
    "pdf.marks-source": "Marks for this row come from: {source}",
    ...
    "pdf.receipt-masthead": "DISCOVERY LAB - SUBMISSION RECEIPT",
    "pdf.receipt-confirmed": "Submission confirmed",
    "pdf.receipt-submitted-at": "Submitted: {date}",
    "pdf.auto-summary-receipt": "Auto-marked Knowledge Check: {score} ({pct}%). Written answers are marked separately by your teacher.",
    "pdf.receipt-marking-note": "These written answers will be marked by your teacher against this activity's assessment criteria. This receipt is your own copy of what you submitted — it does not include the marking scheme.",
  ...
  es: {
    ...
    "stage.observation": "Observación", "stage.question": "Pregunta",
    "observation.title": "Observa de cerca", "observation.lede": "Antes de hacer una pregunta, observa algo real. Explora y descubre qué te llama la atención.",
    "observation.no-activity": "Esta actividad todavía no tiene un paso de observación configurado.",
    "question.title": "¿Qué quieres descubrir?", "question.lede": "Toda investigación comienza con una pregunta real. Elige la que esta investigación está diseñada para responder.",
    "question.note": "Esto no se califica como correcto o incorrecto — es la pregunta que tu hipótesis y tu experimento intentarán responder.",
    ...
    "hypothesis.lede": "Una hipótesis es una suposición fundamentada — tu mejor predicción científica, basada en lo que ya sabes, hecha antes de probar nada. Anota ahora lo que piensas — podrás cambiarlo después de hacer algunas pruebas.",
    "hypothesis.note": "Una hipótesis nunca se califica como correcta o incorrecta — los buenos científicos revisan su hipótesis cuando la evidencia lo indica.",
    ...
    "explain.title.science": "Escribe tu conclusión",
    ...
    "mark-singular": "punto",
    "marks-source": "Los puntos de esta fila provienen de: {source}",
    "skill-focus": "Destreza evaluada: {text}",
    "submission-locked": "Enviado el {date} — tus respuestas están bloqueadas y no se pueden cambiar.",
    "assessed.lock-warning-title": "Importante: ",
    "assessed.lock-warning-body": "Esta es una actividad evaluada. Una vez que pulses Enviar definitivamente, tus respuestas quedarán bloqueadas y no podrás cambiarlas.",
    "assessed.final-submit": "Enviar definitivamente",
    "assessed.confirm-submit": "Una vez que envíes, tus respuestas quedarán bloqueadas y no podrás cambiarlas. ¿Enviar ahora?",
    "assessed.submitted-toast": "Enviado — se ha descargado tu comprobante.",
    "assessed.submitted-on": "Enviado el {date}. Tus respuestas están bloqueadas.",
    "assessed.download-receipt-again": "Descargar de nuevo mi comprobante de entrega",
    "assessed.teacher-only": "Herramienta del profesor",
    "assessed.teacher-note": "Esto genera el documento completo de corrección, incluida la pauta de corrección oculta. No compartas este botón, enlace o archivo con estudiantes que aún no han entregado.",
    "assessed.teacher-generate": "Generar PDF de corrección del profesor",
    ...
    "pdf.student-evidence": "Respuesta del estudiante:",
    "pdf.marking-scheme": "Pauta de corrección — {max} puntos disponibles",
    "pdf.award-point": "Otorgar {marks} {unit} por:",
    "pdf.accept": "Aceptar: ",
    "pdf.insufficient": "No es suficiente por sí solo: ",
    "pdf.depends-on": "Otorgar este punto solo si también se otorgó el punto {n}.",
    "pdf.marks-awarded-blank": "Puntos otorgados: ____ / {max}",
    ...
    "pdf.marks-source": "Los puntos de esta fila provienen de: {source}",
    ...
    "pdf.receipt-masthead": "DISCOVERY LAB - COMPROBANTE DE ENTREGA",
    "pdf.receipt-confirmed": "Entrega confirmada",
    "pdf.receipt-submitted-at": "Enviado: {date}",
    "pdf.auto-summary-receipt": "Comprobación de conocimientos (automática): {score} ({pct}%). Las respuestas escritas las corrige tu profesor por separado.",
    "pdf.receipt-marking-note": "Tu profesor corregirá estas respuestas escritas según los criterios de evaluación de esta actividad. Este comprobante es tu propia copia de lo que enviaste — no incluye la pauta de corrección.",
